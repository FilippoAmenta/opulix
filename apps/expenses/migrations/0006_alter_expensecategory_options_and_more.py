...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('expenses', '0005_alter_expensecategory_budget_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='expensecategory',
            options={'ordering': ['tn_order'], 'verbose_name': 'Expense category', 'verbose_name_plural': 'Expense categories'},
        ),
        ...
        migrations.AddField(
            model_name='expensecategory',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='expenses.expensecategory', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='expensecategory',
            name='tn_priority',
